...
export function HeroStatsTimeline() {
  ...
  return (
    <div className="relative flex flex-col pointer-events-auto select-none">
      ...
      <div
        aria-hidden="true"
        className="absolute left-[17px] top-4 bottom-4 w-px bg-white/15 z-0"
      />
        ...
        {STATS.map((stat, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="relative flex h-[34px] w-[34px] shrink-0 items-center justify-center rounded-xl overflow-hidden elysium-animated-bg border border-white/15 shadow-[0_0_12px_rgba(255,90,0,0.2)] transition-all duration-300 group-hover:scale-105 group-hover:border-[#FF5A00]/60 group-hover:shadow-[0_0_16px_rgba(255,90,0,0.45)]">
                ...
                <Icon className="relative z-10 h-4 w-4 text-white transition-transform duration-200 group-hover:scale-110 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]" />
              </div>
